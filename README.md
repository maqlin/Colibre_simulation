...
* **Type 1**: Stars whose progenitor gas particles were **bound** to the system at the time of formation.
* **Type 1I**: Stars whose progenitor gas particles were bound to the system **and** located at a distance $r < 2R_{50}$.

### **Morphological Classification**
Morphological analysis is conducted exclusively for **Type 1I** stars. The classification is based on the circularity parameter $j_z/j_c$:
...
* **Extended Stars**: Defined as stars that meet the **Type 1** criteria but are **not** classified as **Type 1I**.
...
* **Panel c**: The **angular momentum-energy phase space** of Type 1 young bound stars.
...
* **Panel h**: Distributions of the **current** $j_z/j_c$ and the $j_z/j_c$ **at the time of formation** for Type 1I stars. This panel distinguishes whether stars at a specific redshift were "**born hot/cold**" or if they kinematically evolved over time.
